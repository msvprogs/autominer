...
namespace Msv.AutoMiner.CoinInfoService.Storage
{
    public static class DbInitializer
    {
        ...
        private static void InitializeExchanges(AutoMinerDbContext context)
        {
            ...
            var bittrex = context.Exchanges.First(x => x.Type == ExchangeType.Bittrex);
            bittrex.PublicKey = "2996a0c9f0c94367998e61a239728e22";
            bittrex.PrivateKey = new StringEncryptor().Encrypt("30191467b67c42f388a6931c693ba23b");

            context.SaveChanges();
        }

        private class StringEncryptor 
        {
